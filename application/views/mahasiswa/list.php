                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action=" <?php echo site_url();  ?>mahasiswa/create" method="post" name="submit" id="submit" class="form-horizontal form-bordered submit">
                                <fieldset>
                                    ...
                                    <div class="form-group control-group">
                                        <label class="col-md-4 control-label" for="form-field-1">prodi</label>
                                        <div class="col-md-8 controls">
                                            <input type="text" id="prodi" name="prodi" class="form-control" placeholder="PRODI" maxlength="10">
                                        </div>
                                    </div>
