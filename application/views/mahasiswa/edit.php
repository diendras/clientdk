            ...
            <div class="sidebar-scroll">
                ...
                <div class="sidebar-content">
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li> <a href="<?php echo site_url(); ?>mahasiswa" class=" active"><i class="gi gi-stopwatch sidebar-nav-icon"></i>Rest Client</a>
                        </li>

                        <li>
                            <a href="<?php echo site_url(); ?>mahasiswa"><i class="gi gi-home sidebar-nav-icon"></i>Rest Server</a>
                        </li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-extra">
                                ...
                                <?php echo form_hidden('nim', $datamahasiswa[0]->nim); ?>

                                <form action=" <?php echo base_url(); ?>mahasiswa/create" method="post" name="submit" id="submit" class="form-horizontal form-bordered submit">
                                    <fieldset>
                                        ...
                                        <div class="form-group control-group">
                                            ...
                                            <div class="col-md-8 controls">
                                                <?php echo form_input('', $datamahasiswa[0]->nim, "disabled"); ?>
                                            </div>
                                        </div>
                                        <div class="form-group control-group">
                                            <label class="col-md-4 control-label" for="form-field-1">Nama</label>
                                            <div class="col-md-8 controls">
                                                <?php echo form_input('nama', $datamahasiswa[0]->nama); ?>
                                            </div>
                                        </div>
                                        <div class="form-group control-group">
                                            <label class="col-md-4 control-label" for="form-field-1">Nomor</label>
                                            <div class="col-md-8 controls">
                                                <?php echo form_input('prodi', $datamahasiswa[0]->prodi); ?></td>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-actions">
                                            <div class="col-xs-12 text-right">
                                                ...
                                                <a href="<?php echo site_url();  ?>mahasiswa"> <button mahasiswa" type="button" onClick="return confirm('Anda yakin ingin membatalkan perubahan data?')" data-toggle="tooltip" class="btn btn-sm btn-default">Close</button>
                                                </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header text-center">
                    <h2 class="modal-title"><i class="fa fa-pencil"></i> TAMBAH DATA mahasiswa</h2>
                </div>
                <!-- END Modal Header -->
